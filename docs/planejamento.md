...
- Projeto GCP com Drive API v3 habilitada
- Service Account com credentials.json
- Pasta raiz no Drive compartilhada com a service account
- Variável GOOGLE_SERVICE_ACCOUNT_JSON e GOOGLE_DRIVE_ROOT_FOLDER_ID no .env
...
**Garantir:** Calendar API habilitada, service account com acesso ao calendário, GOOGLE_CALENDAR_ID no .env.
