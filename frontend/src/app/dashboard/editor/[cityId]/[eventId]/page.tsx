      ...
      {board && (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="mb-3 space-y-1">
                {uploadResults.map((r, i) => (
                  <div key={i} className={`text-xs px-3 py-1.5 rounded-lg ${r.success ? "bg-green-50 text-green-700" : "bg-red-50 text-red-600"}`}>
                    ...
                    {r.unlinked && " — sem vínculo (sem EXIF)"}
            ...
            <div className="space-y-2 max-h-[60vh] overflow-y-auto">
              {board.editing.map((t) => (
                ...
                >
                  ...
                  <p className="text-xs text-gray-500 mb-2">{t.mime_type} · {formatSize(t.file_size)}</p>
                  <button
                    onClick={() => {
                      setAbandonTarget(t);
                      setAbandonReason("technical_issue");
          ...
          <section className="bg-white rounded-xl border border-gray-200 p-5">
            ...
            <div className="space-y-2 max-h-[60vh] overflow-y-auto">
              {board.sent.map((t) => (
                <div key={t.task_id} className="p-3 rounded-lg border border-green-100 bg-green-50">
                  <p className="text-sm font-medium text-gray-800 truncate">{t.original_filename}</p>
