"""
Autorização OAuth2 para Google Calendar.

Execute UMA VEZ para gerar docs/calendar_token.json:
    cd backend
...
Pré-requisito: docs/oauth_client.json baixado do GCP Console
  ...
  O mesmo arquivo usado em authorize_drive.py serve.

Após gerar, adicione ao .env:
...
TOKEN_FILE = os.path.join(DOCS_DIR, "calendar_token.json")
...
def main():
    ...
    print(f"Faça login com a conta dona do calendário: consultoria.weslleypalomeque@gmail.com")
    ...
    print("  GOOGLE_OAUTH_CALENDAR_TOKEN_FILE=../docs/calendar_token.json")
